...
public class Consulta {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fechaConsulta, claveOtorgante, nombreOtorgante, direccionOtorgante, telefonoOtorgante, tipoCredito, importeCredito, tipoResponsabilidad, claveUnidadMonetaria, idDomicilio, servicios);
  }
  @Override
